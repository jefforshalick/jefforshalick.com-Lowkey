...
I am in no way an expert in the space but after working with developers for the past 13 years and tinkering with web technologies my whole life, I have a decent understanding of the space and the product offerings within it. Below are some thoughts I had while researching ngrok and the market it's in.
...
ngrok has evolved from a simple command-line tool to a robust enterprise production orchestration product. While this transition has strengthened its enterprise presence, it presents challenges in positioning, education, and adoption—particularly in the mid-market segment.
...
### **1. Reconnecting with the Mid-Market**
**The Gap:** As ngrok expands its enterprise capabilities, mid-market users might struggle with **education, documentation, and onboarding**.
...
### **2. Expanding Perception Beyond Tunneling**
...
This landing experience in app seems like a great opportunity to explain why different customers would want to use agents over SDK's over a Kubernetes implementation.
...
**The Opportunity:** Despite being a highly technical product, **ngrok’s growth appears sales-led** rather than user-driven.
...
Another example: Cloudflare uses premade rules and a traffic sequence diagram to both lower the barrier to entry and illustrate the potential use cases and features they offer.

![image](cloudflare.gif)

On the other hand, even though [it's a year old](https://ngrok.com/blog-post/traffic-policy-engine), ngrok's traffic policy still requires a service upgrade to even see its capabilities in app. Leaning into freemium or just showing the interface without the functionality available could lead to in-app conversions.
...
## **Understanding the Challenge**
ngrok has evolved from a simple command-line tool to a robust networking solution for enterprises. While this transition has strengthened its enterprise presence, it presents challenges in positioning, education, and adoption—particularly in the mid-market segment.

By analyzing **user feedback, industry trends, and competitive dynamics**, we can identify key opportunities for growth.

## **Competitor Landscape: Current vs. Aspirational Positioning**
ngrok has historically been positioned as a **developer-first tunneling tool**, but as the product has matured, its **aspirational competitors** include broader networking and infrastructure platforms. Using the competitor comparison diagram, we can break down key insights:

![image](ngrok_market_venn_diagram.png)

### **Current Competitors** (Where ngrok is today)
...
### **Aspirational Competitors** (Where ngrok could grow)
...
By comparing **current competitors vs. aspirational competitors**, ngrok can refine its positioning, build new capabilities, and expand into higher-value networking and infrastructure markets. I believe the key to success lies in **refining messaging, enhancing accessibility, and better addressing non-experts**—all while staying true to ngrok’s core technical strengths.
